...
HARD_REJECT = re.compile(
    ...
    r"electrician|finance officer|programme officer|project manager|"
    r"research officer|analyst|clerk|assistant|maritime|safety|marine|navigation|"
    r"port|ship|seafarer)", re.I)
